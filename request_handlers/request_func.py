...
def create_requests(product_number: list) -> list:
    ...
    for i in product_number:
        ...
        # Getting total pages of a form_number
        pages = get_total_pages(req.content)
...
# After getting all content needed, looping to get souped_data. This is
# for scraping useful for us data.
...
def get_souped_data(data: list):
    ...
    # Returns three lists for showing right data
